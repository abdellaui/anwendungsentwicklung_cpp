...
QT_MOC_LITERAL(1, 12, 9), // "gotValues"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 14) // "onClickedTrain"

    },
    "TrainWidget\0gotValues\0\0onClickedTrain"
};
...
void TrainWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gotValues((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        case 1: _t->onClickedTrain(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (TrainWidget::*_t)(double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TrainWidget::gotValues)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TrainWidget::gotValues(double _t1, double _t2)
{
