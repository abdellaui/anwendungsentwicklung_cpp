...
QT_MOC_LITERAL(4, 32, 12), // "on_new_Image"
QT_MOC_LITERAL(5, 45, 23) // "on_current_item_changed"

    },
    "FilterWidget\0new_Image\0\0cv::Mat\0"
    "on_new_Image\0on_current_item_changed"
};
...
void FilterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_new_Image((*reinterpret_cast< cv::Mat(*)>(_a[1]))); break;
        case 2: _t->on_current_item_changed((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FilterWidget::new_Image)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FilterWidget::new_Image(cv::Mat _t1)
{
